...
public interface OffHeapQueue {
     ...
     */
    String writeMessage(byte[] message, String moduleName) throws WriteFailedException;
     ...
     *
     * @return key, value pair where key is the uuid and value is the head of this queue
